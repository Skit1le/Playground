...
def make_ranked_zone() -> RankedZone:
    return RankedZone(
        ...
        score_weights=WeightedScoreConfig(
            temp_suitability=0.2222,
            temp_gradient=0.1481,
            temp_break_proximity=0.0741,
            structure_proximity=0.1667,
            chlorophyll_suitability=0.1019,
            current_suitability=0.1204,
            weather_fishability=0.1667,
        ),
        weighted_score_breakdown=WeightedScoreBreakdown(
            temp_suitability=22.2,
            temp_gradient=12.4,
            temp_break_proximity=6.6,
            structure_proximity=13.3,
            chlorophyll_suitability=10.2,
            current_suitability=11.6,
            weather_fishability=15.3,
        ),
