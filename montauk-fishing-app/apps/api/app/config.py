...
class Settings(BaseSettings):
    ...
    sst_map_target_cells: int = Field(default=7584, alias="SST_MAP_TARGET_CELLS")
    sst_break_scoring_target_cells: int = Field(default=960, alias="SST_BREAK_SCORING_TARGET_CELLS")
    sst_break_strong_threshold_f_per_nm: float = Field(default=0.05, alias="SST_BREAK_STRONG_THRESHOLD_F_PER_NM")
